...
Microaction {
    ...
    // = XISAAC Microactions =
    uA_CUSTOM0_def       (CUSTOM0),
    uA_CUSTOM0_reg       (CUSTOM0 -> Xd),
    // -----------------------
    uA_MUL_I   (MUL_I),
    uA_MUL_O   (MUL_O -> Xd),
    uA_DIV     (DIV),
...
Stage {
    ...
    // = XISAAC EX Substages =
    EX_substage_CUSTOM0    (uA_CUSTOM0_def, uA_CUSTOM0_reg),
    // ----------------------
...
Pipeline {
    ...
    // = XISAAC EX Pipeline =
    EX_subpipe_CUSTOM0 (EX_substage_CUSTOM0),
    // ----------------------
...
Pipeline CVA6XISAAC_pipeline (PC_stage -> IF_stage -> IQ_stage -> ID_stage -> IS_stage -> EX_stage -> COM_stage)
...
/**************************************** Variants *****************************************/
CorePerfModel CVA6XISAAC (
  core : "RV64IMACFD"
  use Pipeline : CVA6XISAAC_pipeline
...
MicroactionMapping {
    ...
    XIsaac_CUSTOM0 : {uA_IScan, uA_OF_A, uA_OF_B, uA_Clobber, uA_CUSTOM0_reg, uA_Commit_Cb},
    // ------------------------------
